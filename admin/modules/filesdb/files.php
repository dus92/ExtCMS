...
if(!empty($_POST['newsave'])){
	...
	if($filesdb->createFile($_POST['newsave'] - 1, @$_POST['title'], @$_POST['desc'], @$_POST['link'], $size, @$_POST['author'], @$_POST['license'], @$_POST['platform'], @$_POST['preview'])) {
	...
	if($filesdb->updateFile($_POST['cid']-1, $_POST['edit'], @$_POST['title'], @$_POST['desc'], @$_POST['link'], $size, @$_POST['author'], @$_POST['preview'])) {
...
if(!empty($_POST['new'])){
	...
	$frm->addrow(__('License'), $frm->text_box('license', ''));
	$frm->addrow(__('Platform'), $frm->text_box('platform', ''));
	...
	$frm->addrow(__('Filename of preview file'), $frm->text_box('preview', ''));
	$frm->show();
	...
	$frm->addrow(__('Filename of preview file'), $frm->text_box('preview', @basename($filesdb->data[$cid]['files'][$fid]['preview'])));
	$frm->show();
