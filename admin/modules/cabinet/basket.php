...
$id = $iblockitem->GetTableAINextValue ();
    ...
    {        
        ...
        $frm->addsingle('<tr id="tr_basket_header"><th colspan="4">'.__('Basket').'</th></tr>');
        $frm->addsingle('<tr class="row1"><td><div id="adm_div_basket"></div></td></tr>');
        $frm->addsingle('<tr class="row1"><td><div id="div_basket_tools" style="display:none;"><input type="submit" value="'.__('Delete').'" name="btn_delete_basket" /><input type="submit" value="'.__('Read').'" name="btn_read_basket" /><input type="submit" value="'.__('Unread').'" name="btn_unread_basket" /><input type="submit" value="'.__('To blacklists').'" name="btn_blacklists_basket" /><input type="submit" value="'.__('Remove from basket').'" name="btn_from_basket" /></div></td></tr>');        
...
//        }       
        ...
        print(" $('.adm_link_input').click(function()
                ...
                for (var i=0;i<letters.length;i++)
                {
                    ...
                    {
                        $('#adm_div_'+letters[i]).html('".__('There are no letters')."');
                    }
                }
    ...
    else if (!empty($_POST['mess_input_click'])) //подробный просмотр входящих сообщений
    {
        ...
        print('<script type="text/javascript">
            $(document).ready(function()
            {
                ...
                {                   
                   $("form[name=frm_input]").attr("action", "admin.php?show=module&id=cabinet.basket"); 
    ...
    else if (!empty($_POST['mess_output_click'])) //подробный просмотр отправленных сообщений
    {
        ...
        print('<script type="text/javascript">
            $(document).ready(function()
            {
                $(".btnmain").click(function()
                {                   
                   $("form[name=frm_output]").attr("action", "admin.php?show=module&id=cabinet.basket"); 
