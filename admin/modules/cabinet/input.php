...
// //////////////////////////////////////////////////////////////////////////////
//rcms_showAdminMessage( var_dump($_POST));
error_reporting (55);
$iblock = new iBlock ();
...
$id = $iblockitem->GetTableAINextValue ();
    ...
    //////////////////////////////////////////////////////////  
    if (empty($_POST['mess_input_click']) )//отображение писем
    {        
        ...
        $frm->addsingle('<tr id="tr_input_header"><th colspan="4">'.__('Input').'</th></tr>');
        ...
        $date_arr = array(); // массив дат входящих писем
        $mes_info = '';
        ...
        while ( $to = $imail->Read ( $resultid ) ) 
        {
            ...
            $date_arr[$count_mes_input] = $to['date_time'];
                            ...
                            if ($to['blacklists'] == '1')
                                ...
                                ");        
                                    ...
                                    {                                                                                
                                        ...
                                        $mes_info .= $mess_input[$count_mes_input];                                            
                                    }                                                                                                                                                                                                     
                            $count_mes_input++;                                                                    
                        }                                                                                                                 
                    }                       
...
//            print("if (!$('#adm_div_input').html())                                         
//                     $('.ch_show').parent().hide();
//            ");    
//        }
                                                          
        print(" 
                function link_input_click(link){
                  link.click(function()
                  {
                ...
                link_input_click($('.adm_link_input'));               
        ...
        print('<script type="text/javascript">
            $(document).ready(function()
            {
                ...
                {                   
                   //history.back();
                  // return false;
                  $("form[name=frm_input]").attr("action", "admin.php?show=module&id=cabinet.input"); 
