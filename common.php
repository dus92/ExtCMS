...
// Defining constants                                                         //
////////////////////////////////////////////////////////////////////////////////
define('RCMS_VERSION_A', '2');
define('RCMS_VERSION_B', '0');
define('RCMS_VERSION_C', '0a');
define('RCMS_LINK', 'http://hakkahcms.sourceforge.net');
define('RCMS_COPYRIGHT', '&copy; 2008-'.date("Y").' <a href="http://hakkahcms.sourceforge.net">Hakkah~CMS Team</a>');
define('RCMS_POWERED', '<a href="' . RCMS_LINK . '">Powered by Hakkah~CMS</a>');
// ReloadCMS Back-compability [non-mysql functionality]
define('RCMS_COMPABILITY', false);
...
define('JSS_PATH',       	 RCMS_ROOT_PATH . 'modules/js/');
define('MODULES_TPL_PATH',   RCMS_ROOT_PATH . 'modules/templates/');
define('IBLOCKS_TPL_PATH',   RCMS_ROOT_PATH . 'content/iblocks/templates/');
...
define('PREVIEWS_PATH', DATA_PATH . 'previews/');
define('IBLOCKS_PATH',  DATA_PATH . 'iblocks/');
define('GROUPICONS_PATH',  DATA_PATH . 'groupicons/');

// Set internal encoding
mb_internal_encoding("UTF-8"); // TODO: add mb_ extension check to installer

// Cookies
define('FOREVER_COOKIE', time()+3600*24*365*5);

// HCMS
define('FILE_NTEMPLATES',true);
...
while ($em = readdir($em_dir)){
	if(mb_substr($em, 0, 1) != '.' && is_file(ENGINE_PATH . $em)){
