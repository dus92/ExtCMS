...
<table cellpadding="2" cellspacing="1" style="width: 100%;">
<tr>
    <td class="row2" colspan="2"><a href="index.php?module=user.profile&amp;act=password_request"><?=__('I forgot my password')?></a></td>
</tr>
<tr>
    <td class="row2" colspan="2"><a href="index.php?module=user.profile&amp;act=register"><?=__('Register')?></a></td>
</tr>
<?php } else {?>
...
<tr>
    <td class="row3">
        <a href="index.php?module=articles.post"><?=__('Post article')?></a>
    </td>
</tr>
<?php }?>
<tr>
    <td class="row2">
        <a href="index.php?module=user.profile"><?=__('My profile')?></a>
    </td>
</tr>
<tr>
    <td class="row2">
