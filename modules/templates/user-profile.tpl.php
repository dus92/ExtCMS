...
<?php if(($tpldata['mode'] !== 'registration_form' || empty($system->config['regconf'])) && isset($_GET['admin'])){?>
<tr>
	<td width="100%" colspan="2" align="center"><h4 style="color: red;""><?=__('This account will have root administrator\'s rights')?></h4></td>
</tr>
<?php } ?>
<tr>
...
<tr>
    ...
    $selected = array_search($tpldata['values']['timezone'], $tzs);
...
<?php } ?>
<tr>
    <td colspan="2" align="center"><input type="submit" value="<?=__('Submit')?>" /></td>
</tr>
</table>
</form>