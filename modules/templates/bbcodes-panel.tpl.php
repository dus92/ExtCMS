...
<script language="javascript" type="text/javascript" src="<?=JSS_PATH?>editor.js"></script>
...
<tr>
    <td align="center"><a href="javascript:bbstyle(document.forms['<?=$dta[0]?>'].elements['<?=$dta[1]?>'], -1, '<?=$tpldata['textarea']?>')"><?=__('Close tags')?></a></td>
</tr>
</table>